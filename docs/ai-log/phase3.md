...
Sipariş tamamlandığında tetiklenecek eylemleri dinamik kılmak adına Observer örüntüsü üzerine 30 dakikalık mimari bir çalışma yürütülmüştür. AlisverisGecidiFacade sınıfı "Subject" (özne) haline getirilerek, bildirim yapılarının dışarıdan inject edilmesi sağlanmıştır.
